    ...
    <div class="main-container pt-20">
        <div class="container">
            <div class="grid grid-cols-3 gap-1">
                <div class="">
                    <h1 class="text-4xl underline">Nom du pays</h1>
                </div>
                <div class=""><img
        ...
        <div class="grid grid-cols-2">
            ...
            <div class="grid grid-rows-2 gap-1">
                <div class="">
                    <h1 class="text-2xl">Spécial Char</h1>
                    <div class="text-lg">ñ</div>
                    <div>
                        <x-log :country="$country" scope='Caractère'></x-log>
                    </div>

                    <div class="">
                        <h1 class="text-2xl">Language</h1>
                    ...
                    <div class="grid grid-row-3 gap-1">
                        ...
                        <div>
                            <x-log :country="$country" scope="Panneau"></x-log>
                        </div>
                        <div class="grid grid-row-3 gap-1">
                            <div class="">
                                <h1 class="text-3xl">Drapeau</h1>
